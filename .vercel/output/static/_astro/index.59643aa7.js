import{s as l,g as a}from"./_astro_assets.f981976e.js";import{c as r,r as d,m as p}from"./render-template.4296f3c4.js";import{u as c}from"./hoisted.43f9c696.js";import"./astro-assets-services.5d54009f.js";const h={src:"/_astro/logo.1c6fa3ee.png",width:512,height:512,format:"png"},u={src:"/_astro/about-astro.850f94c9.png",width:249,height:450,format:"png"},g=async function(){return{"./logo.png":await a({src:h}),"@/assets/about-astro.png":await a({src:u})}};async function f(t){return g().then(e=>t.replaceAll(/__ASTRO_IMAGE_="([^"]+)"/gm,(i,n)=>l({src:e[n].src,...e[n].attributes})))}const o=await f(`<h2 id="this-is-a-h2-heading">This is a H2 Heading</h2>
